...
const emptyBoard = { tasks: [], stickers: [], links: [], achievements: [] };
...
describe("board storage", () => {
  ...
  it("loads the backup file when the primary board file is corrupt", async () => {
    ...
    const board = { tasks: [{ id: "task-1" }], stickers: [], links: [], achievements: [] };
  ...
  it("writes via a temporary file and keeps a recoverable backup", async () => {
    const storage = await makeStore();
    const first = { tasks: [{ id: "task-1" }], stickers: [], links: [], achievements: [], updatedAt: "2026-05-18T09:30:00.000Z" };
    const second = { tasks: [{ id: "task-2" }], stickers: [], links: [], achievements: [], updatedAt: "2026-05-19T09:30:00.000Z" };
