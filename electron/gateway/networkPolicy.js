...
export function validateNetworkPolicy({ mode = "personal", host = "127.0.0.1", allowLan = false, enableUpnp = false } = {}) {
  ...
  return { mode, host, allowLan: Boolean(allowLan), enableUpnp: false };
}
